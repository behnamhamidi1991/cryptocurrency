...
export const blogPosts: Blog[] = [
  {
    id: 1,
    title: "آیا روند رمزارز ها صعودی خواهد بود؟",
    content:
      "با نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است. ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.",
    time: "دو ساعت پیش",
    category: "رمزارز",
    view: 425,
    image: blog,
  ...
  {
    id: 2,
    title: "شوک جدید به بازار کریپتو",
    content:
      "با نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است. ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.",
    time: "دو ساعت پیش",
    category: "رمزارز",
  ...
  {
    id: 3,
    title: "بررسی عوامل لیکویید شدن تریدرها",
    content:
      "با نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.",
    time: "چهار ساعت پیش",
    category: "رمزارز",
  ...
  {
    id: 5,
    title: "سیاست های جدید در قبال رمزارزها",
    content:
      "با نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.ا نزدیک شدن به رویداد هاوینگ بیت‌کوین، احساس خوش‌بینی در بازار ارزهای دیجیتال افزایش یافته است. این خوش‌بینی باعث افزایش قیمت برخی ارزهای دیجیتال از جمله توکن پایت نتورک (PYTH) شده است.",
    time: "چهار ساعت پیش",
    category: "رمزارز",
  ...
  {
    id: 6,
    title: "استفاده از تکنولوژی در حوزه ارز دیجیتال",
